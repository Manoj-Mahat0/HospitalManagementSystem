...
public class paymentHistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 940, 510));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 670, -1, -1));
        ...
        jLabel3.setText("                 ");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1000, 800));
  ...
  try
                                 {
                                     ...
                                     ResultSet rs=st.executeQuery("select patient.pid,rno,name,mob,age,gender,address,symptoms,doctor,medical_charge,ward_charge,testing_charge,other_charge,total,bill.date from patient,diagonosis,bill where patient.pid=diagonosis.pid and patient.pid=bill.pid;" );
